...
* [[`37abad4340`](https://github.com/nodejs/node/commit/37abad4340)] - **(SEMVER-MAJOR)** **build**: reset embedder string to "-node.0" (Michaël Zasso) [#32831](https://github.com/nodejs/node/pull/32831)
...
* [[`1d6adf7432`](https://github.com/nodejs/node/commit/1d6adf7432)] - **(SEMVER-MAJOR)** **deps**: update V8 to 8.3.110.9 (Michaël Zasso) [#32831](https://github.com/nodejs/node/pull/32831)
...
* [[`a85ce885bd`](https://github.com/nodejs/node/commit/a85ce885bd)] - **(SEMVER-MAJOR)** **src**: remove deprecated node debug command (James M Snell) [#33648](https://github.com/nodejs/node/pull/33648)
* [[`308900faef`](https://github.com/nodejs/node/commit/308900faef)] - **(SEMVER-MAJOR)** **src**: update NODE\_MODULE\_VERSION to 84 (Michaël Zasso) [#32831](https://github.com/nodejs/node/pull/32831)
...
* [[`60c4c2b6c5`](https://github.com/nodejs/node/commit/60c4c2b6c5)] - **(SEMVER-MAJOR)** **src**: runtime deprecate process.umask() (Colin Ihrig) [#32499](https://github.com/nodejs/node/pull/32499)
* [[`08e8997d54`](https://github.com/nodejs/node/commit/08e8997d54)] - **(SEMVER-MAJOR)** **stream**: simpler and faster Readable async iterator (Robert Nagy) [#34035](https://github.com/nodejs/node/pull/34035)
...
* [[`6213fcee9b`](https://github.com/nodejs/node/commit/6213fcee9b)] - **(SEMVER-MAJOR)** **stream**: save error in state (Robert Nagy) [#34103](https://github.com/nodejs/node/pull/34103)
...
* [[`d1156d0d2f`](https://github.com/nodejs/node/commit/d1156d0d2f)] - **(SEMVER-MAJOR)** **test**: rename FinalizationGroup to FinalizationRegistry (Shu-yu Guo) [#32831](https://github.com/nodejs/node/pull/32831)
